...
@section('content')
@include('properties.partials.header', ['title' => __('Add New Property')])   
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Property Management') }}</h3>
                        </div>
                    ...
                    <form method="post" action="{{ route('properties.store') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="type" id="input-name" class="form-control form-control-alternative{{ $errors->has('type') ? ' is-invalid' : '' }}" placeholder="{{ __('Type') }}" value="{{ old('type') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('buying_price') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" name="buying_price" id="input-name" class="form-control form-control-alternative{{ $errors->has('buying_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Buying Price') }}" value="{{ old('buying_price') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('selling_price') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-name">{{ __('Selling Price') }}</label>
                                <input type="number" name="selling_price" id="input-name" class="form-control form-control-alternative{{ $errors->has('selling_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Selling Price') }}" value="{{ old('selling_price') }}" required autofocus>
