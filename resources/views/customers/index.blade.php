...
@section('content')
@include('customers.partials.header', ['title' => __('Customers List')])   
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Total Customers -') }} ({{ $count  }}) </h3>
                        </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                           ...
                                           <form action="{{ route('customers.destroy', $lead) }}" method="post">
                                            @csrf
                                            @method('delete')

                                            <a class="dropdown-item" href="{{ route('customers.edit', $lead) }}">{{ __('Edit') }}</a>
