@extends('layouts.app', ['title' => __('Agent Management')])

@section('content')
    @include('users.partials.header', ['title' => __('Add New Agent')])   
                        ...
                        <form method="post" action="{{ route('agents.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('first_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="first_name" id="input-name" class="form-control form-control-alternative{{ $errors->has('first_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Last Name') }}" value="{{ old('first_name') }}" required autofocus>
